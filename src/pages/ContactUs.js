export default function ContactUs() {
  ...
  return (
    <div style={{ padding: '32px', backgroundColor: '#E8E8F1', minHeight: '100vh' }}>
      <h1 style={{ fontSize: '36px', fontWeight: 'bold', marginBottom: '10px',textAlign:'center' }}>Get In Touch</h1> 
      <p style={{ color: '#666', marginBottom: '40px',fontSize:'20px',textAlign:'center' }}>If you have any questions or need assistance? We're here to help you on your journey to success.</p>

      
      <div style={contentAreaStyle}>
        
        {/* Block 1: Contact Information */}
        <div style={{ flexShrink: 0, width: '480px', background: '#ECEEF3', padding: 24, borderRadius: 10, boxShadow: '0 4px 10px rgba(0,0,0,0.05)' }}>
