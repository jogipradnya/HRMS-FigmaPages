...
const PrivacyPolicy = () => {
  return (
    <div className="flex flex-col h-full w-full max-w-6xl mx-auto">
      ...
      <div className="bg-[#EBEBF0]/50 md:bg-white/40 backdrop-blur-sm border-2 border-white rounded-[2rem] p-6 md:p-10 h-full relative flex flex-col shadow-sm overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto pr-2 custom-scrollbar space-y-5 pb-24 md:pb-0">
        ...
        */}
        <div className="absolute bottom-6 left-0 right-0 md:left-auto md:right-10 flex justify-center md:block pointer-events-none">
          <button 
